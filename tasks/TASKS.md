...
- [>] [TASK-136] Define success metrics for pilots — concrete KPIs for "working" (latency reduction, cost savings, accuracy improvement). Output measurable targets per ICP. Output to workspace-ops/processes/success-metrics.md · priority:med · owner:ops · project:slancha · created:2026-03-31 · started:2026-03-31
